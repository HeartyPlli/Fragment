...
*/
  ...
  'c-mirror': SubScene(
    ...
    overlays: [
      ...
      SubHotspot(
        id: 'mepic',
        asset: 'assets/images/Stage 3/mepic2.png',
  ...
  'c-hint': SubScene(
    ...
    overlays: [
      SubHotspot(
        id: 'h2',
        asset: 'assets/images/Stage 3/hintstage31.png',
      ...
      SubHotspot(
        id: 'h3',
        asset: 'assets/images/Stage 3/hintstage32.png',
      ...
      SubHotspot(
        id: 'h4',
        asset: 'assets/images/Stage 3/hintstage33.png',
        offset: Offset(300, 180),
        width: 120,
        draggable: true,
      ),
    ],
