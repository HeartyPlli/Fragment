...
const Map<String, SubScene> subScenes = {
  ...
  'sofa-table': SubScene(
    id: 'sofa-table',
    background: 'assets/images/table/backgroundtable.png',
    overlays: [
      SubHotspot(
        id: 't0',
  ...
  'sofa-frame1': SubScene(
    ...
    overlays: [
      ...
      SubHotspot(
        id: 'frame1-01-1',
        asset: 'assets/images/Frames/01.1.png',
        offset: Offset(209, 115),
        width: 73,
      ),
      SubHotspot(
        id: 'frame1-01-2',
        asset: 'assets/images/Frames/01.2.png',
        offset: Offset(282, 115),
        width: 73,
      ),
      SubHotspot(
        id: 'frame1-01-3',
        asset: 'assets/images/Frames/01.3.png',
        offset: Offset(209, 204),
        width: 73,
      ),
      SubHotspot(
        id: 'frame1-01-4',
        asset: 'assets/images/Frames/01.4.png',
        offset: Offset(283, 203),
        width: 73,
      ),
    ],
  ),
...
*/
  ...
  'c-hint': SubScene(
    ...
    overlays: [
      ...
      SubHotspot(
        id: 'h3',
        asset: 'assets/images/hint/hint2.png',
